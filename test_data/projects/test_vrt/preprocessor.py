...
FILES = {
    'data': 'data.csv',
    'occurrences': os.path.join(DATA_DIR, 'occurrences.csv'),
    'identifications': os.path.join(DATA_DIR, 'identifications.csv'),
    'measurements': os.path.join(DATA_DIR, 'measurementOrFact.csv')
}
...
class PreProcessor(AbstractPreProcessor):
    ...
    def __transform_data(self, base_data):
        ...
        # uuid4 - creates randomly generated unique id
